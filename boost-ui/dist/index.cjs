      ...
      children: [
        ...
        images.length > 1 && /* @__PURE__ */ jsxRuntime.jsx(
          "div",
          {
            ...
            children: images.map((img, idx) => /* @__PURE__ */ jsxRuntime.jsx(
              "button",
              {
                type: "button",
      ...
      /* @__PURE__ */ jsxRuntime.jsx("div", { style: { display: "flex", flexWrap: "wrap", gap: "8px" }, children: group.options.map((opt) => {
        ...
        return /* @__PURE__ */ jsxRuntime.jsxs(
          "button",
          {
            ...
            children: [
              /* @__PURE__ */ jsxRuntime.jsx("span", { children: opt.value }),
      ...
      children: [
        ...
        /* @__PURE__ */ jsxRuntime.jsxs("div", { style: { padding: "10px", display: "flex", flexDirection: "column", gap: "5px", flex: 1 }, children: [
          ...
          /* @__PURE__ */ jsxRuntime.jsxs("div", { style: { display: "flex", alignItems: "baseline", gap: "6px", marginTop: "1px" }, children: [
            ...
            compareAtPrice && compareAtPrice > price && /* @__PURE__ */ jsxRuntime.jsxs("span", { style: { fontSize: "11px", color: "#94a3b8", textDecoration: "line-through" }, children: [
              "\u20B9",
              compareAtPrice
            ] })
          ] }),
        ...
        /* @__PURE__ */ jsxRuntime.jsxs(
          "div",
          {
            ...
            children: [
              ...
              /* @__PURE__ */ jsxRuntime.jsx("div", { style: { marginTop: "8px" }, children: /* @__PURE__ */ jsxRuntime.jsx(StarRating, { rating: averageRating, size: 20 }) }),
              /* @__PURE__ */ jsxRuntime.jsxs(
                "span",
                {
                  style: {
            ...
            children: [
              /* @__PURE__ */ jsxRuntime.jsxs("div", { style: { display: "flex", flexDirection: "column", gap: "16px" }, children: [
                ...
                /* @__PURE__ */ jsxRuntime.jsxs("div", { style: { marginTop: "8px" }, children: [
                  ...
                  subscribed ? /* @__PURE__ */ jsxRuntime.jsx(
                    "div",
                    {
                      style: {
                        color: "#34d399",

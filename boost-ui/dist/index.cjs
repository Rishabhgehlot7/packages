  ...
  return /* @__PURE__ */ jsxRuntime.jsxs(
    "div",
    {
      ...
      children: [
        ...
        /* @__PURE__ */ jsxRuntime.jsxs("div", { style: { padding: "14px", display: "flex", flexDirection: "column", gap: "8px", flex: 1 }, children: [
          brand && /* @__PURE__ */ jsxRuntime.jsx("span", { style: { fontSize: "10px", fontWeight: 800, color: "#6b7280", textTransform: "uppercase" }, children: brand }),
          /* @__PURE__ */ jsxRuntime.jsx(
            "h3",
            {
              onClick,
          ...
          rating !== void 0 && /* @__PURE__ */ jsxRuntime.jsx(StarRating, { rating, reviewCount, size: 13 }),
          /* @__PURE__ */ jsxRuntime.jsxs("div", { style: { display: "flex", alignItems: "baseline", gap: "6px", marginTop: "2px" }, children: [
            /* @__PURE__ */ jsxRuntime.jsxs("span", { style: { fontSize: "15px", fontWeight: 800, color: "#111827" }, children: [
              "\u20B9",
              price
            ] }),
            compareAtPrice && compareAtPrice > price && /* @__PURE__ */ jsxRuntime.jsxs("span", { style: { fontSize: "12px", color: "#9ca3af", textDecoration: "line-through" }, children: [

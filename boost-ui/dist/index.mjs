  ...
  if (label) {
    return /* @__PURE__ */ jsxs(
      "div",
      {
        ...
        children: [
          /* @__PURE__ */ jsx("div", { style: { flex: 1, height: "1px", backgroundColor: "#e2e8f0" } }),
          /* @__PURE__ */ jsx("span", { style: { fontSize: "12px", color: "#64748b", fontWeight: 500, textTransform: "uppercase", letterSpacing: "0.05em" }, children: label }),
          /* @__PURE__ */ jsx("div", { style: { flex: 1, height: "1px", backgroundColor: "#e2e8f0" } })
        ]
      }
    );
...
var VStack = React.forwardRef((props, ref) => /* @__PURE__ */ jsx(Stack, { ref, direction: "column", ...props }));
VStack.displayName = "VStack";
var HStack = React.forwardRef((props, ref) => /* @__PURE__ */ jsx(Stack, { ref, direction: "row", align: "center", ...props }));
...
var Sidebar = ({
  ...
  return /* @__PURE__ */ jsxs(
    "aside",
    {
      ...
      children: [
        header && /* @__PURE__ */ jsx("div", { style: { padding: "16px", borderBottom: "1px solid #f1f5f9" }, children: header }),
        /* @__PURE__ */ jsx("div", { style: { flex: 1, overflowY: "auto", padding: "12px 8px", display: "flex", flexDirection: "column", gap: "16px" }, children: groups.map((grp, gIdx) => /* @__PURE__ */ jsxs("div", { style: { display: "flex", flexDirection: "column", gap: "4px" }, children: [
          grp.title && !collapsed && /* @__PURE__ */ jsx("span", { style: { fontSize: "11px", fontWeight: 600, color: "#94a3b8", textTransform: "uppercase", padding: "4px 12px", letterSpacing: "0.05em" }, children: grp.title }),
          grp.items.map((item) => {
            ...
            return /* @__PURE__ */ jsxs(
              "div",
              {
                ...
                children: [
                  item.icon && /* @__PURE__ */ jsx("span", { style: { display: "inline-flex", color: isActive ? "#2563eb" : "#64748b" }, children: item.icon }),
                  !collapsed && /* @__PURE__ */ jsx("span", { style: { flex: 1, whiteSpace: "nowrap", overflow: "hidden", textOverflow: "ellipsis" }, children: item.label }),
                  !collapsed && item.badge && /* @__PURE__ */ jsx("span", { style: { fontSize: "11px", fontWeight: 600, padding: "2px 6px", borderRadius: "9999px", backgroundColor: isActive ? "#dbeafe" : "#f1f5f9", color: isActive ? "#1d4ed8" : "#64748b" }, children: item.badge })
                ]
              },
              item.id
            );
        ...
        footer && /* @__PURE__ */ jsx("div", { style: { padding: "16px", borderTop: "1px solid #f1f5f9" }, children: footer })
      ]
    }
  );
};
...
var Breadcrumb = ({
  ...
  const defaultSeparator = /* @__PURE__ */ jsx("svg", { width: "14", height: "14", viewBox: "0 0 24 24", fill: "none", stroke: "#94a3b8", strokeWidth: "2", children: /* @__PURE__ */ jsx("polyline", { points: "9 18 15 12 9 6" }) });
  return /* @__PURE__ */ jsx("nav", { "aria-label": "Breadcrumb", className: `boost-breadcrumb ${className}`, style: { fontFamily: "inherit" }, children: /* @__PURE__ */ jsx("ol", { style: { display: "flex", alignItems: "center", gap: "8px", listStyle: "none", padding: 0, margin: 0 }, children: items.map((item, idx) => {
    const isLast = idx === items.length - 1;
    return /* @__PURE__ */ jsxs("li", { style: { display: "inline-flex", alignItems: "center", gap: "8px", fontSize: "13px" }, children: [
      isLast || !item.href ? /* @__PURE__ */ jsx("span", { style: { fontWeight: 600, color: "#0f172a" }, children: item.label }) : /* @__PURE__ */ jsx(
        "a",
        {
          href: item.href,
          style: {
      ...
      !isLast && /* @__PURE__ */ jsx("span", { style: { display: "inline-flex" }, children: separator || defaultSeparator })
    ] }, idx);
  }) }) });
};
...
export { Accordion, ActivityFeed, AddToCart, AddressForm, Alert, AnnouncementBar, AspectRatio, AssuredBadge, Avatar, AvatarGroup, BackButton, Badge, BankOffersAccordion, BoostProvider, BottomSheet, Box, Breadcrumb, Button, ButtonGroup, CTASection, Card, CardContent, CardDescription, CardFooter, CardHeader, CardTitle, Carousel, CartDrawer, Checkbox, Chip, CommandPalette, ConfirmationDialog, Container, CopyButton, CouponInput, DataTable, DatePicker, DateRangePicker, Dialog, Divider, Drawer, DropdownMenu, DualMobileActionBar, EmptyState, ErrorState, ExportButton, FAQSection, FeatureGrid, FileDropzone, FileUpload, Filter, Flex, FloatingActionButton, Footer, ForgotPassword, FormField, FrequentlyBoughtTogether, Grid, GridItem, HStack, Header, HeroSection, IconButton, Image, Input, KPIWidget, LightningDealsBar, LinkButton, Loader, LoginForm, LogoCloud, MegaMenu, MobileBottomBar, MobileBottomNav, Modal, Motion, MultiSelect, NavLink, Navbar, NotificationCenter, OTPInput, OrderSummary, OrderTimeline, PageWrapper, Pagination, PincodeChecker, Popover, Portal, Price, PricingTable, ProductCard, ProductGallery, ProgressBar, QuantitySelector, Radio, RadioGroup, RegisterForm, ResetPassword, ReviewBreakdownBars, ScrollArea, SearchInput, Section, Select, Sidebar, Skeleton, Snackbar, Sort, Spinner, Stack, StarRating, StatsCard, Stepper, StickyAddToCart, SuccessMessage, Switch, Table, Tabs, Tag, TestimonialCard, TestimonialGrid, Textarea, TimePicker, Toast, ToastProvider, Tooltip, TrustBadges, VStack, VariantSelector, clamp, cn, debounce, deepMerge, formatCurrency, formatDate, formatNumber, formatRelativeTime, generateId, getInitials, groupBy, isValidEmail, isValidIndianMobile, isValidIndianPincode, omit, pick, slugify, truncate, useClickOutside, useCopyToClipboard, useDebounce, useForm, useIntersectionObserver, useIsomorphicLayoutEffect, useLocalStorage, useMediaQuery, usePrevious, useScrollPosition, useTheme, useToast, useToggle, useWindowSize };

'use client';
import { useFocusTrap } from './chunk-5U3HN6OU.mjs';
export { useAnnounce, useBreakpoint, useClickOutside, useCopyToClipboard, useDebounce, useFocusTrap, useForm, useIntersectionObserver, useIsomorphicLayoutEffect, useLocalStorage, useMediaQuery, usePrevious, useScrollPosition, useToggle, useWindowSize } from './chunk-5U3HN6OU.mjs';
...
export { boostTokens, createTailwindPreset, darkTokens, lightTokens, resolveTokens, tokensToCssVars } from './chunk-QA5ZVZOC.mjs';
import { useBoostPreset, useTheme } from './chunk-DQZ6QIRW.mjs';
export { BoostProvider, injectBoostGlobalStyles, useBoostPreset, useCurrency, useDesignTokens, useTheme } from './chunk-DQZ6QIRW.mjs';
import { presetTokens } from './chunk-JFWYG6ZK.mjs';
export { presetTokens } from './chunk-JFWYG6ZK.mjs';
import { __publicField } from './chunk-QLGN3SVU.mjs';
    ...
    if (this.state.hasError && this.state.error) {
      ...
      return /* @__PURE__ */ jsxs(
        "div",
        {
          ...
          role: "alert",
          children: [
            /* @__PURE__ */ jsx("p", { style: { fontWeight: 600, margin: "0 0 8px" }, children: "\u26A0\uFE0F Something went wrong" }),
            /* @__PURE__ */ jsx("p", { style: { margin: "0 0 12px", opacity: 0.8, fontSize: "13px" }, children: this.state.error.message || "An unexpected error occurred" }),
            /* @__PURE__ */ jsx(
              "button",
              {
...
var ThemeToggle = ({
  ...
  const [standaloneMode, setStandaloneMode] = React47.useState(() => {
...
var Button = /* @__PURE__ */ React47.forwardRef(
  ({
    children,
    variant = "primary",
    size = "md",
      ...
      switch (preset) {
        ...
        case "glassmorphism":
          return {
            backdropFilter: "blur(12px)",
            WebkitBackdropFilter: "blur(12px)",
            border: isSolid ? "1px solid rgba(255, 255, 255, 0.25)" : "1px solid var(--boost-glass-border, rgba(226, 232, 240, 0.8))",
            boxShadow: isPrimary ? "0 6px 20px rgba(37, 99, 235, 0.35)" : isDestructive ? "0 6px 20px rgba(220, 38, 38, 0.35)" : "0 6px 20px rgba(0, 0, 0, 0.1)",
            ...!isSolid ? {
        ...
        case "gradient-glow":
          return {
            boxShadow: isPrimary ? "0 0 20px rgba(99, 102, 241, 0.45), 0 0 0 1px rgba(99, 102, 241, 0.45)" : isDestructive ? "0 0 20px rgba(239, 68, 68, 0.45)" : "0 0 14px rgba(99, 102, 241, 0.25)"
          };
        case "material-you":
          return {
            borderRadius: "9999px",
...
var IconButton = /* @__PURE__ */ React47.forwardRef(
  ({
    icon,
    label,
    ariaLabel,
  ...
  return /* @__PURE__ */ jsx(
    "div",
    {
      ...
      children: React47.Children.map(children, (child, idx) => {
        ...
        const total = React47.Children.count(children);
        const isLast = idx === total - 1;
        const typedChild = child;
        return React47.cloneElement(typedChild, {
          style: {
...
var Input = /* @__PURE__ */ React47.forwardRef(
  ({
    label,
    error,
    helperText,
...
var Textarea = /* @__PURE__ */ React47.forwardRef(
  ({
    label,
    error,
    helperText,
...
var Select = /* @__PURE__ */ React47.forwardRef(
  ({
    label,
    error,
    helperText,
...
var Checkbox = /* @__PURE__ */ React47.forwardRef(
...
var Radio = /* @__PURE__ */ React47.forwardRef(
...
var Switch = /* @__PURE__ */ React47.forwardRef(
  ({
    checked = false,
    onChange = () => {
    },
...
var DatePicker = ({
  ...
  const generatedId = React47.useId ? React47.useId().replace(/:/g, "") : `date-picker-${Math.random().toString(36).substring(2, 7)}`;
...
var FileUpload = ({
  ...
  const [fileList, setFileList] = React47.useState([]);
  const inputRef = React47.useRef(null);
  const handleDrop = (e) => {
    e.preventDefault();
    setIsDragOver(false);
...
var SearchInput = /* @__PURE__ */ React47.forwardRef(
  ({
    value,
    onChange,
    onClear,
...
var OTPInput = /* @__PURE__ */ React47.forwardRef(
  ({
    length = 6,
    value = "",
    onChange = () => {
    ...
    const inputsRef = React47.useRef([]);
    React47.useImperativeHandle(ref, () => inputsRef.current[0]);
...
var ToastContext = React47.createContext(void 0);
var ToastProvider = ({
  children,
  position = "bottom-right",
  defaultDuration = 4e3
  ...
  const addToast = React47.useCallback(
    (options) => {
  ...
  const toastMethods = React47.useMemo(() => {
    ...
    "div",
    {
      ...
      children: [
        ...
        /* @__PURE__ */ jsxs("div", { style: { flex: 1, minWidth: 0 }, children: [
          ...
          content && /* @__PURE__ */ jsx("div", { style: { fontSize: "13px", color: preset === "neo-brutalism" ? "var(--boost-text, #000)" : colors.textColor, lineHeight: 1.5 }, children: content })
        ] }),
        onClose && /* @__PURE__ */ jsx(
          "button",
          {
...
var Card = /* @__PURE__ */ React47.forwardRef(
  ({
    hoverable = false,
    variant = "elevated",
    stylePreset: stylePresetProp,
...
var Image = ({
  ...
  const [isLoaded, setIsLoaded] = React47.useState(false);
  const getAspect = () => {
...
var Avatar = ({
  ...
  const [imgError, setImgError] = React47.useState(false);
  const getSize = () => {
    switch (size) {
      case "sm":
      ...
      children: [
        visibleAvatars.map((child, index) => /* @__PURE__ */ jsx(
          "div",
          {
            ...
            children: React47.isValidElement(child) && size ? React47.cloneElement(child, { size }) : child
          },
          index
        )),
...
var Tooltip = ({
  ...
  const [isVisible, setIsVisible] = React47.useState(false);
  const containerRef = React47.useRef(null);
  const tooltipId = React47.useId ? React47.useId().replace(/:/g, "") : `tooltip-${Math.random().toString(36).substring(2, 7)}`;
  React47.useEffect(() => {
    if (!isVisible) return;
    const handleKeyDown = (e) => {
      if (e.key === "Escape") {
...
var Carousel = ({
  ...
  const [currentIdx, setCurrentIdx] = React47.useState(0);
  const slidesList = Array.isArray(items) ? items : Array.isArray(props.slides) ? props.slides.map((s) => s?.content || s) : [];
  const [touchStart, setTouchStart] = React47.useState(null);
  const [touchEnd, setTouchEnd] = React47.useState(null);
  const prevSlide = () => {
...
var Popover = ({
  ...
  const popoverRef = React47.useRef(null);
...
var CommandPalette = ({
  ...
  const [selectedIndex, setSelectedIndex] = React47.useState(0);
  const inputRef = React47.useRef(null);
  React47.useEffect(() => {
    if (isOpen) {
      setQuery("");
...
var Box = /* @__PURE__ */ React47.forwardRef(
  ({
    as = "div",
    children,
    p,
    ...
    return /* @__PURE__ */ jsx(Component2, { ref, className: `boost-box ${className}`, style: computedStyle, ...props, children });
  }
);
Box.displayName = "Box";
var Flex = /* @__PURE__ */ React47.forwardRef(
  ({
    children,
    direction = "row",
    justify = "flex-start",
...
var Grid = /* @__PURE__ */ React47.forwardRef(
  ({
    children,
    cols = 1,
    gap = "16px",
    ...
    const rawId = React47.useId ? React47.useId() : Math.random().toString(36).substring(2, 9);
...
var GridItem = /* @__PURE__ */ React47.forwardRef(
  ({
    children,
    colSpan,
    rowSpan,
...
var Section = /* @__PURE__ */ React47.forwardRef(
  ({
    children,
    maxWidth = "1200px",
    py = "64px",
...
var AspectRatio = /* @__PURE__ */ React47.forwardRef(
...
var ScrollArea = /* @__PURE__ */ React47.forwardRef(
  ({
    children,
    maxHeight = "400px",
    maxWidth = "100%",
...
var Motion = ({
  ...
  const [inView, setInView] = React47.useState(false);
...
var Navbar = ({
  ...
  const preset = stylePresetProp ?? inheritedPreset;
  const [mobileMenuOpen, setMobileMenuOpen] = React47.useState(false);
  const [localSearch, setLocalSearch] = React47.useState(searchValue || "");
  const [openDropdown, setOpenDropdown] = React47.useState(null);
  const [announcementVisible, setAnnouncementVisible] = React47.useState(true);
  const [expandedMobileItem, setExpandedMobileItem] = React47.useState(null);
  React47.useEffect(() => {
  ...
  const [mobileSearchOpen, setMobileSearchOpen] = React47.useState(false);
...
var Footer = ({
  ...
  const [subscribed, setSubscribed] = React47.useState(false);
  const [emailError, setEmailError] = React47.useState(null);
  const [openMobileColumns, setOpenMobileColumns] = React47.useState({});
...
var MobileBottomBar = ({
  ...
  const { stylePreset: inheritedPreset } = useBoostPreset();
  const preset = stylePresetProp ?? inheritedPreset;
  const [internalActiveTab, setInternalActiveTab] = React47.useState(activeTab || defaultActiveTab);
  React47.useEffect(() => {
    if (activeTab !== void 0) {
...
var MobileBottomNav = ({
  ...
  const { stylePreset: inheritedPreset } = useBoostPreset();
  const preset = stylePresetProp ?? inheritedPreset;
  const [internalActiveId, setInternalActiveId] = React47.useState(activeId || defaultActiveId || items[0]?.id);
  React47.useEffect(() => {
    if (activeId !== void 0) {
...
var DropdownMenu = ({
  ...
  const preset = stylePresetProp ?? inheritedPreset;
  const [isOpen, setIsOpen] = React47.useState(false);
  const [focusedIndex, setFocusedIndex] = React47.useState(-1);
  const containerRef = React47.useRef(null);
  const triggerRef = React47.useRef(null);
  const itemRefs = React47.useRef([]);
  React47.useMemo(() => {
...
var MegaMenu = ({
  ...
  const [activeCategory, setActiveCategory] = React47.useState(categories?.[0]?.id || "");
  ...
  const effectiveSections = React47.useMemo(() => {
...
var TabsContext = React47.createContext(null);
var useTabsContext = () => React47.useContext(TabsContext);
var Tabs = (({
  tabs,
  items,
  defaultTab,
  ...
  const [internalTab, setInternalTab] = React47.useState(
...
function DataTable({
  ...
  const [internalPage, setInternalPage] = React47.useState(1);
  const [internalSelectedRows, setInternalSelectedRows] = React47.useState([]);
  const [sortColumn, setSortColumn] = React47.useState(null);
  const [sortDirection, setSortDirection] = React47.useState("asc");
  ...
  const handleExportCSV = () => {
    ...
    const rows = processedData.map(
      (row) => columns.map((col) => {
        ...
        if (typeof val === "object" && val !== null && !React47.isValidElement(val)) {
          val = JSON.stringify(val);
        } else if (React47.isValidElement(val)) {
...
var AreaChart = ({
  ...
  const [hoverIndex, setHoverIndex] = React47.useState(null);
...
var NotificationCenter = ({
  ...
  const preset = stylePresetProp ?? inheritedPreset;
  const [isOpen, setIsOpen] = React47.useState(false);
  const [filter, setFilter] = React47.useState("all");
  const containerRef = React47.useRef(null);
  const unreadCount = notifications.filter((n) => !n.read).length;
  const filteredNotifications = React47.useMemo(() => {
    if (filter === "unread") {
...
var CartDrawer = ({
  ...
  const { stylePreset: inheritedPreset } = useBoostPreset();
  const preset = stylePresetProp ?? inheritedPreset;
  const [isCheckingOut, setIsCheckingOut] = React47.useState(false);
  React47.useEffect(() => {
    if (!isOpen) return;
    const handleKeyDown = (e) => {
      if (e.key === "Escape") {
...
var StickyAddToCart = ({
  ...
  const [quantity, setQuantity] = React47.useState(1);
  const [isAdding, setIsAdding] = React47.useState(false);
  const [isBuying, setIsBuying] = React47.useState(false);
  const [addedFeedback, setAddedFeedback] = React47.useState(false);
...
var PincodeChecker = ({
  ...
  const [pincode, setPincode] = React47.useState(defaultPincode);
  const [loading, setLoading] = React47.useState(false);
  const [result, setResult] = React47.useState(null);
  const [error, setError] = React47.useState(null);
  const activeRequestIdRef = React47.useRef(0);
  const isMountedRef = React47.useRef(true);
  React47.useEffect(() => {
...
var StarRating = ({
  ...
  const gradientId = React47.useId ? React47.useId().replace(/:/g, "") : `half-star-${Math.random().toString(36).substring(2, 7)}`;
  return /* @__PURE__ */ jsxs(
    "div",
    {
...
var ProductGallery = ({
  ...
  const preset = stylePresetProp ?? inheritedPreset;
  const [selectedIndex, setSelectedIndex] = React47.useState(0);
  const [isHovered, setIsHovered] = React47.useState(false);
  const [zoomPos, setZoomPos] = React47.useState({ x: 0, y: 0 });
  const normalizedImages = React47.useMemo(() => {
  ...
  const [isMobile, setIsMobile] = React47.useState(false);
  React47.useEffect(() => {
    if (typeof window === "undefined") return;
    ...
    switch (preset) {
      ...
      case "neumorphism":
        return {
          ...
          border: "none",
          borderRadius: "20px",
          boxShadow: isHovered ? "var(--card-shadow-hover, 8px 8px 18px #c5cad3, -8px -8px 18px #ffffff)" : "var(--card-shadow, 6px 6px 14px #d1d9e6, -6px -6px 14px #ffffff)",
...
var AnnouncementBar = ({
  ...
  const { stylePreset: inheritedPreset } = useBoostPreset();
  const [isVisible, setIsVisible] = React47.useState(true);
  const [copied, setCopied] = React47.useState(false);
  const [currentIdx, setCurrentIdx] = React47.useState(0);
...
var LightningDealsBar = ({
  ...
  const { stylePreset: inheritedPreset } = useBoostPreset();
  const preset = stylePresetProp ?? inheritedPreset;
  const [timeLeft, setTimeLeft] = React47.useState({
    hours: 2,
    minutes: 0,
    seconds: 0,
    isExpired: false
...
var FrequentlyBoughtTogether = ({
  ...
  const { stylePreset: inheritedPreset } = useBoostPreset();
  const preset = stylePresetProp ?? inheritedPreset;
  const allItems = React47.useMemo(() => {
    const list = [];
  ...
  const [selectedIds, setSelectedIds] = React47.useState(
    () => allItems.map((i) => i.id)
  );
  React47.useEffect(() => {
    setSelectedIds(allItems.map((i) => i.id));
  }, [allItems]);
  const [imageErrors, setImageErrors] = React47.useState({});
  const toggleItem = (id) => {
...
var BankOffersAccordion = ({
  ...
  const [copiedCode, setCopiedCode] = React47.useState(null);
...
var PricingTable = ({
  ...
  const { stylePreset: inheritedPreset } = useBoostPreset();
  const preset = stylePresetProp ?? inheritedPreset;
  const [internalCycle, setInternalCycle] = React47.useState(billingCycle);
...
var FAQSection = ({
  ...
  const { stylePreset: inheritedPreset } = useBoostPreset();
  const preset = stylePresetProp ?? inheritedPreset;
  const [openIds, setOpenIds] = React47.useState([]);
  const [searchQuery, setSearchQuery] = React47.useState("");
...
var CTASection = ({
  ...
  const preset = stylePresetProp ?? inheritedPreset;
  const [email, setEmail] = React47.useState("");
  const [submitted, setSubmitted] = React47.useState(false);
  const handleSubmit = (e) => {
    e.preventDefault();
    if (!email) return;
...
export { Accordion, ActivityFeed, AddToCart, AddressForm, Alert, AnnouncementBar, AreaChart, AspectRatio, AssuredBadge, Avatar, AvatarGroup, BackButton, Badge, BankOffersAccordion, BarChart, BottomSheet, Box, Breadcrumb, Button, ButtonGroup, CTASection, Card, CardContent, CardDescription, CardFooter, CardHeader, CardTitle, Carousel, CartDrawer, Checkbox, Chip, CommandPalette, ConfirmationDialog, Container, CopyButton, CouponInput, DataTable, DatePicker, DateRangePicker, Dialog, Divider, DonutChart, Drawer, DropdownMenu, DualMobileActionBar, EmptyState, ErrorBoundary, ErrorState, ExportButton, FAQSection, FeatureGrid, FileDropzone, FileUpload, Filter, Flex, FloatingActionButton, Footer, ForgotPassword, FormField, FrequentlyBoughtTogether, Grid, GridItem, HStack, Header, HeroSection, IconButton, Image, Input, KPIWidget, LightningDealsBar, LinkButton, Loader, LoginForm, LogoCloud, MegaMenu, MobileBottomBar, MobileBottomNav, Modal, Motion, MultiSelect, NavLink, Navbar, NotificationCenter, OTPInput, OrderSummary, OrderTimeline, PageWrapper, Pagination, PincodeChecker, Popover, Portal, PresetSwitcher, Price, PricingTable, ProductCard, ProductGallery, ProgressBar, QuantitySelector, Radio, RadioGroup, RegisterForm, ResetPassword, ReviewBreakdownBars, ScrollArea, SearchInput, Section, Select, Sidebar, Skeleton, Snackbar, Sort, Sparkline, Spinner, Stack, StarRating, StatsCard, Stepper, StickyAddToCart, SuccessMessage, Switch, Table, Tabs, TabsContent, TabsList, TabsTrigger, Tag, TestimonialCard, TestimonialGrid, Textarea, ThemeToggle, TimePicker, Toast, ToastProvider, Tooltip, TrustBadges, VStack, VariantSelector, presetHelperClasses, presetTokenCssVars, useToast };

export { UseFormOptions, useAnnounce, useClickOutside, useCopyToClipboard, useDebounce, useFocusTrap, useForm, useIntersectionObserver, useIsomorphicLayoutEffect, useLocalStorage, useMediaQuery, usePrevious, useScrollPosition, useToggle, useWindowSize } from './hooks/index.mjs';
export { clamp, cn, debounce, deepMerge, formatCurrency, formatDate, formatNumber, formatRelativeTime, generateId, getInitials, groupBy, isValidEmail, isValidIndianMobile, isValidIndianPincode, omit, pick, slugify, truncate } from './utils/index.mjs';
...
interface MotionProps extends React.HTMLAttributes<HTMLDivElement> {
    animation?: 'fade-in' | 'slide-up' | 'slide-down' | 'scale-in' | 'spring-pop' | 'slide-in-right' | 'slide-in-left' | 'spin' | 'pulse' | 'bounce' | 'shimmer';
    duration?: number;
    delay?: number;

@echo off
echo ========================================================
echo  Boost Engine Payments - 1-Click NPM Publish
echo ========================================================
echo.
...
echo.
echo [3/3] Publishing @boostengine/payments to npm publicly...
call npm publish --access public
if %errorlevel% equ 0 (
    echo.
    echo ========================================================
    echo  SUCCESS! @boostengine/payments published to npm publicly!
    echo ========================================================
) else (
    echo.

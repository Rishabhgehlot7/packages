...
var PaymentAgentToolkit = class {
  ...
  static simulateWebhook(options) {
    ...
    if (gateway === "razorpay") {
      ...
      const signature = crypto__default.default.createHmac("sha256", webhookSecret).update(rawBody2).digest("hex");
      return {
        rawBody: rawBody2,
        headers: {
...
exports.PaymentAgentToolkit = PaymentAgentToolkit;
...
exports.UPIIntentGenerator = UPIIntentGenerator;

@echo off
echo ========================================================
echo  Boost Engine Deals - 1-Click NPM Publish
echo ========================================================
echo.
...
echo.
echo [3/3] Publishing @boostengine/deals to npm publicly...
call npm publish --access public
if %errorlevel% equ 0 (
    echo.
    echo ========================================================
    echo  SUCCESS! @boostengine/deals v1.1.0 published to npm!
    echo ========================================================
) else (
    echo.

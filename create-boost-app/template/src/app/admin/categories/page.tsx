...
export default function AdminCategoriesPage() {
  ...
  return (
    <div className="space-y-6 sm:space-y-8">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
        <div className="bg-slate-900/80 border border-slate-800 p-5 rounded-2xl flex items-center justify-between">
          <div>
            ...
            <div className="text-[11px] text-slate-500 mt-0.5">Direct from MongoDB</div>
          </div>
        ...
        <div className="bg-slate-900/80 border border-slate-800 p-5 rounded-2xl flex items-center justify-between">
          <div>
            ...
            <div className="text-2xl font-black text-white mt-1">{mainCategoriesCount}</div>
            <div className="text-[11px] text-indigo-400 mt-0.5">Top-level collections</div>
          </div>
        ...
        <div className="bg-slate-900/80 border border-slate-800 p-5 rounded-2xl flex items-center justify-between">
          <div>
            ...
            <div className="text-2xl font-black text-white mt-1">{subCategoriesCount}</div>
            <div className="text-[11px] text-emerald-400 mt-0.5">Linked to parent tree</div>
          </div>
      ...
      {/* Main Table & Cards */}
      <div className="bg-slate-900/70 border border-slate-800 rounded-2xl overflow-hidden backdrop-blur shadow-xl">
        {loading ? (
          ...
          <div className="text-center py-20">
            <FolderTree className="w-12 h-12 text-slate-600 mx-auto mb-3 opacity-50" />
              ...
              <table className="w-full text-left border-collapse text-xs">
                ...
                <tbody className="divide-y divide-slate-800/60 font-medium">
                  {filteredCategories.map((cat, idx) => {
                    ...
                    return (
                      <tr key={catId} className="hover:bg-slate-800/30 transition">
                        <td className="py-4 px-5 flex items-center gap-3">
                          <div className="w-10 h-10 rounded-xl bg-slate-800 overflow-hidden relative flex-shrink-0 border border-slate-700/60">
                            {cat.image ? (
                              <img
                                src={cat.image}
                                alt={cat.name}
                        ...
                        <td className="py-4 px-5 text-slate-300">
                          {parentName ? (
                            ...
                            <span className="text-slate-600 text-[11px]">— (Top Root)</span>
                          )}
                        </td>
                          ...
                          >
                            <span
                              className={`w-1.5 h-1.5 rounded-full ${
                                cat.isActive ? 'bg-emerald-400' : 'bg-slate-500'
                              }`}
                            />
                        ...
                        <td className="py-4 px-5 text-right space-x-1">
                          <button
                            ...
                            className="p-1.5 rounded-lg text-slate-400 hover:text-white hover:bg-slate-800 inline-flex transition cursor-pointer"
                            title="Edit Category"
                          >
                          ...
                          <button
                            ...
                            className="p-1.5 rounded-lg text-rose-400 hover:text-rose-300 hover:bg-rose-500/10 inline-flex transition cursor-pointer"
                  ...
                  <div key={catId} className="p-4 space-y-3">
                    ...
                    <div className="flex items-center justify-between pt-1 border-t border-slate-800/60 text-xs text-slate-400">
                      ...
                      <div className="flex items-center space-x-1">
                        ...
                        <button
                          onClick={() => handleDelete(cat.id || (cat as any)._id, cat.name)}
                          className="px-2.5 py-1 bg-rose-500/10 hover:bg-rose-500/20 text-rose-400 rounded-lg text-[10px] font-bold"
                        >
                          Delete
                        </button>
                      </div>
          ...
          <div className="bg-slate-900 border border-slate-800 rounded-2xl max-w-lg w-full p-6 space-y-5 shadow-2xl animate-in zoom-in-95 duration-200">
            ...
            <form onSubmit={handleSaveCategory} className="space-y-4">
              ...
              <div className="grid grid-cols-2 gap-3">
                <div>
                  ...
                  <input
                    ...
                    className="w-full px-3.5 py-2 bg-slate-950 border border-slate-800 rounded-xl text-xs text-white font-mono placeholder-slate-500 focus:outline-none focus:border-indigo-500"
                  />
                </div>
                <div>
                  <label className="block text-xs font-semibold text-slate-300 mb-1.5">
              ...
              <div className="flex items-center space-x-2 pt-1">
                ...
                />
                <label htmlFor="catActive" className="text-xs font-semibold text-slate-300">
